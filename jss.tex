...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, breakable, borderline west={3pt}{0pt}{shadecolor}, boxrule=0pt, interior hidden, enhanced, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
\IfFileExists{xurl.sty}{\usepackage{xurl}}{} % add URL line breaks if available
\urlstyle{same}
\hypersetup{
  pdftitle={Analysis of 2009 LaGuardia Airport Data to Reccomend Travel Plans},
  pdfauthor={Ryan Joesting; Jimmy John},
...
%% Author information
\usepackage[top=.75in, bottom=.75in, left=.75in, right=.75in, footskip=0.25in]{geometry}
\author{Ryan Joesting\\The University of Alabama \And Jimmy John\\The
University of Alabama}
\Plainauthor{Ryan Joesting, Jimmy John} %% comma-separated

\title{Analysis of 2009 LaGuardia Airport Data to Reccomend Travel
Plans}
\Plaintitle{Analysis of 2009 LaGuardia Airport Data to Reccomend Travel
Plans} %% without formatting
...
E-mail: \email{rmjoesting@crimson.ua.edu}\\
\\~
Jimmy John\\
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-color-frame, colback=white, rightrule=.15mm, toprule=.15mm, breakable, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, left=2mm, opacityback=0]
...
\pandocbounded{\includegraphics[keepaspectratio]{article-visualization.pdf}}
